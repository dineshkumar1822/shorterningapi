...
const itemInput = document.getElementById('usr'); //getting input url
...
function addItems(slink,llink){
    ...
    urls.append(item);
    // console.log(item)
    item.addEventListener("",event=>{console.log(event)}) 
}
...
//  var list=document.querySelector("#simpleList")
    // list.addEventListener("change",event=>{console.log(event)})
    // console.log(list)
   
//     window.sessionStorage
//     sessionStorage.setItem(llink,'large');
//     sessionStorage.setItem(slink,'small');
//     const mode = sessionStorage.getItem('llink');
// console.log(llink); // 'dark'